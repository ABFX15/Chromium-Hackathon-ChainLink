...
export function Navbar({ activeTab, onTabChange }: NavbarProps) {
  const navigationItems = [
    ...
    },
    {
      ...
      label: "Cross-Chain",
      icon: Shield,
      description: "Cross Chain Lending",
    },
  ];
            ...
            {navigationItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`premium-nav-link group ${
                    isActive ? "active" : ""
                  }`}
                ...
                >
                  ...
                  {/* Hover glow effect */}
                  <div
                    className={`absolute inset-0 bg-gradient-to-r from-cyan-400/5 to-blue-400/5 rounded-xl transition-all duration-300 ${
                      isActive
                        ? "opacity-100"
